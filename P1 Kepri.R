...
miskin    <- read.xlsx("E:/Workshop Spatial Econometrics/P1.xlsx", sheetName = "Sheet1")
...
png("E:/BAPPENAS/2020_P1/2020_P1_Kepri.png", width = 800, height = 600, units = "px")
plot(kepri.poly[,ncol(kepri.poly)])
dev.off()
...
png("E:/BAPPENAS/2020_P1/2020_P1_MoranPlot_kepri.png", width = 800, height = 600, units = "px")
moran.plot(c(na.omit(X)), keprilistw, zero.policy = T, 
           main="Global Moran P1 2020", pch=16, col="black", cex=3.5)
dev.off()

sink("E:/BAPPENAS/2020_P1/2020_P1_MoranTest_kepri.txt")
moran.test(c(na.omit(X)), keprilistw, zero.policy = T)
sink()

sink("E:/BAPPENAS/2020_P1/2020_P1_LocalMoranTest_kepri.txt")
...
png("E:/BAPPENAS/2020_P1/2020_P1_pval_LocalMoran_kepri.png", width = 800, height = 600, units = "px")
...
png("E:/BAPPENAS/2020_P1/2020_P1_Ival_LocalMoran_kepri.png", width = 800, height = 600, units = "px")
tm_shape(localmoran_map) +
  tm_fill(col = "Ii",
          style = "quantile",
...
png("E:/BAPPENAS/2020_P1/2020_P1_ClusterLocal_kepri.png", width = 800, height = 600, units = "px")
tm_shape(local_g) + 
