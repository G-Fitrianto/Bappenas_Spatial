...
sulsel.centroid <- st_centroid(sulsel.poly)


png("E:/BAPPENAS/IPM/2020_IPM_sulsel.png", width = 1400, height = 1000, units = "px")
plot(sulsel.poly[,ncol(sulsel.poly)])
#text(st_coordinates(sulsel.centroid$geometry), labels = sulsel.poly$NAME_2)
dev.off()
...
png("E:/BAPPENAS/IPM/2020_IPM_MoranPlot_Sulsel.png", width = 800, height = 600, units = "px")
moran.plot(c(na.omit(X)), sulsellistw, zero.policy = T, 
           main="Global Moran Sulawesi Selatan 2020", pch=16, col="black", cex=3.5)
dev.off()

sink("E:/BAPPENAS/IPM/2020_IPM_MoranTest_Sulsel.txt")
moran.test(c(na.omit(X)), sulsellistw, zero.policy = T)
sink()

sink("E:/BAPPENAS/IPM/2020_IPM_LocalMoranTest_Sulsel.txt")
...
png("E:/BAPPENAS/IPM/2020_IPM_pval_LocalMoran_Sulsel.png", width = 800, height = 600, units = "px")
...
png("E:/BAPPENAS/IPM/2020_IPM_Ival_LocalMoran_Sulsel.png", width = 800, height = 600, units = "px")
tm_shape(localmoran_map) +
  tm_fill(col = "Ii",
          style = "quantile",
