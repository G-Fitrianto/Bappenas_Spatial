...
ina.shp    <- st_read("D:/Shapefiles/Indonesia/gadm41_IDN_2.shp")
...
ina.shp$pdrb_2020    <- as.numeric(pdrb_20$X2020) 
...
colnames(papua.poly)
w.det  <- which(colnames(papua.poly) == "growth_2020")

mycol <- colorRampPalette(c("lightblue", "darkblue"))
png("E:/BAPPENAS 2023/Eco Growth/Eco Growth_papua.png", width = 1400, height = 1000, units = "px")
plot(papua.poly[,w.det], col=mycol(nrow(papua.poly)))
dev.off()
...
png("E:/BAPPENAS 2023/Eco Growth/Eco Growth_MoranPlot_papua.png", width = 800, height = 600, units = "px")
moran.plot(c(na.omit(X)), papualistw, zero.policy = T, 
           main="Global Moran P0 Jawa Tengah 2020", pch=16, col="black", cex=3.5)
dev.off()

sink("E:/BAPPENAS 2023/Eco Growth/Eco Growth_MoranTest_papua.txt")
moran.test(c(na.omit(X)), papualistw, zero.policy = T)
sink()

sink("E:/BAPPENAS 2023/Eco Growth/Eco Growth_LocalMoranTest_papua.txt")
...
png("E:/BAPPENAS 2023/Eco Growth/Eco Growth_pval_LocalMoran_papua.png", width = 1400, height = 1000, units = "px")
...
png("E:/BAPPENAS 2023/Eco Growth/Eco Growth_Ival_LocalMoran_papua.png", width = 1400, height = 1000, units = "px")
tm_shape(localmoran_map) +
  tm_fill(col = "Ii",
          style = "quantile",
...
png("E:/BAPPENAS 2023/Eco Growth/Eco Growth_ClusterLocal_papua.png", width = 1400, height = 1000, units = "px")
tm_shape(local_g) + 
